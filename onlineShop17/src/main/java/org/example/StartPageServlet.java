...
public class StartPageServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<form align='left' method='post' action='" + req.getContextPath() + "/menuShop'>");
        writer.println("<p style='height: 10px;'><input type='text' name='clientName' placeholder='Enter your name' style='width: 150px;'></p>");
        writer.println("<p><input type='checkbox' name='checked' value='true'>I agree with the terms of service</p>");
